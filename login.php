...
<head>
    ...
    <style>
        ...
        @keyframes nodePulse {
            0% { r: 4px; opacity: 0.5; filter: drop-shadow(0 0 2px rgba(37,99,235,0.3)); }
            100% { r: 8px; opacity: 1; filter: drop-shadow(0 0 10px rgba(37,99,235,0.7)); }
        }
        ...
        /* High Visibility Interactive Input Fields */
        .form-control {
...
<svg class="depot-network-canvas" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice">
    ...
    <path class="transit-path" d="M-100,200 L400,200 L600,450 L1600,450" fill="none" stroke="#2563eb" stroke-width="3" opacity="0.6" filter="drop-shadow(0 0 4px rgba(37,99,235,0.3))"/>

    <path d="M200,1000 L500,600 L800,450 L900,-100" fill="none" stroke="rgba(15,23,42,0.03)" stroke-width="2" />
    <path class="transit-path-fast" d="M200,1000 L500,600 L800,450 L900,-100" fill="none" stroke="#10b981" stroke-width="2" opacity="0.6" filter="drop-shadow(0 0 4px rgba(16,185,129,0.3))"/>
    
    <circle class="depot-node" cx="400" cy="200" r="5" fill="#2563eb" />
    <circle class="depot-node" cx="600" cy="450" r="6" fill="#2563eb" />
...
<div class="main-card-wrapper">
    ...
    <div class="brand-profile-container d-flex align-items-center">
        ...
        <div>
            <h4 class="fw-bold text-dark mb-0" style="letter-spacing: -0.5px;">SRMSS Gateway</h4>
            <p class="text-muted small fw-medium mb-0">Smart Route Management System</p>
        </div>
    </div>
    ...
    <div class="card login-card border-0">
        <div class="card-body p-4 p-md-4">
            <form action="authenticate.php" method="POST">
                ...
                <div class="mb-3">
                    <label for="username" class="form-label small form-label-highlight mb-2">Username or ID Key</label>
                ...
                <div class="mb-4">
                    <label for="password" class="form-label small form-label-highlight mb-2">Security Account Password</label>
                    <div class="input-group">
                ...
                <button type="submit" class="btn btn-primary btn-submit text-white w-100 mb-3 shadow-sm">
                    Sign In Matrix Panel <i class="bi bi-box-arrow-in-right ms-1"></i>
                </button>
                
                <div class="text-center pt-2">
                    <a href="register.php" class="text-decoration-none small fw-bold signup-link">
                        <i class="bi bi-person-plus-fill me-1"></i> Missing identity? Register Profile Account
                    </a>
                </div>
            </form>
        </div>
