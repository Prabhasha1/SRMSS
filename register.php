...
<head>
    ...
    <style>
        ...
        @keyframes nodePulse {
            0% { r: 4px; opacity: 0.3; filter: drop-shadow(0 0 2px rgba(16,185,129,0.4)); }
            100% { r: 8px; opacity: 1; filter: drop-shadow(0 0 10px rgba(16,185,129,0.9)); }
        }
        ...
        option { background-color: #0b0f19; color: #fff; }
        ...
        .login-link { transition: all 0.2s ease; }
        .login-link:hover { color: #2563eb !important; letter-spacing: 0.3px; }
    </style>
</head>
...
<svg class="depot-network-canvas" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice">
    ...
    <path class="transit-path" d="M-100,200 L400,200 L600,450 L1600,450" fill="none" stroke="#10b981" stroke-width="3" filter="drop-shadow(0 0 5px #059669)"/>

    <path d="M200,1000 L500,600 L800,450 L900,-100" fill="none" stroke="rgba(255,255,255,0.05)" stroke-width="2" />
    <path class="transit-path-fast" d="M200,1000 L500,600 L800,450 L900,-100" fill="none" stroke="#2563eb" stroke-width="2" filter="drop-shadow(0 0 5px #1e3a8a)"/>
    ...
    <div class="card register-card border-0">
        <div class="card-body p-4 p-md-5">
            ...
            <div class="text-center">
                ...
                <h3 class="fw-bold text-white mb-1" style="letter-spacing: -0.5px;">Create Account</h3>
                <p class="text-muted small fw-medium mb-4">Register new Depot Staff or System Administrators</p>
            </div>
            
            <?php if (isset($_GET['error'])): ?>
                <div class="alert alert-danger p-3 bg-danger-subtle text-danger border-0 small rounded-3 mb-3 text-center" role="alert">
                    <i class="bi bi-exclamation-triangle-fill me-2"></i><?php echo htmlspecialchars($_GET['error']); ?>
                </div>
            <?php endif; ?>
            
            <?php if (isset($_GET['success'])): ?>
                <div class="alert alert-success p-3 bg-success-subtle text-success border-0 small rounded-3 mb-3 text-center" role="alert">
            ...
            <form action="register_process.php" method="POST">
                <div class="mb-3">
                    <label for="username" class="form-label small fw-bold text-secondary mb-2">Username or ID String</label>
                ...
                <div class="mb-3">
                    <label for="role" class="form-label small fw-bold text-secondary mb-2">Assigned Depot System Role</label>
                    <div class="input-group">
                        <span class="input-group-text px-3"><i class="bi bi-briefcase-fill"></i></span>
                ...
                <div class="mb-3">
                    <label for="password" class="form-label small fw-bold text-secondary mb-2">Secure Gateway Password</label>
                    <div class="input-group">
                ...
                <div class="mb-4">
                    <label for="confirm_password" class="form-label small fw-bold text-secondary mb-2">Confirm String Matching Verification</label>
                    <div class="input-group">
                        <span class="input-group-text px-3"><i class="bi bi-shield-check"></i></span>
                        <input type="password" name="confirm_password" id="confirm_password" class="form-control" placeholder="••••••••••••" required>
                    </div>
                </div>
                
                <button type="submit" class="btn btn-success btn-submit text-white w-100 mb-4 shadow-sm">
                ...
                <div class="text-center border-top border-secondary border-opacity-20 pt-3">
                    <a href="login.php" class="text-decoration-none small text-primary fw-bold login-link">
